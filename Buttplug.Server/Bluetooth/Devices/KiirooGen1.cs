...
{
    internal class KiirooGen1BluetoothInfo : IBluetoothDeviceInfo
    {
        ...
        {
            return new KiirooGen1(aLogManager, aInterface, this);
        }
    }

    internal class KiirooGen1 : ButtplugBluetoothDevice
    {
        ...
        public KiirooGen1([NotNull] IButtplugLogManager aLogManager,
        ...
        public override async Task<ButtplugMessage> Initialize()
        {
            ...
            await Interface.WriteValue(ButtplugConsts.SystemMsgId,
                Info.Characteristics[(uint)KiirooGen1BluetoothInfo.Chrs.Cmd],
            ...
            await Interface.WriteValue(ButtplugConsts.SystemMsgId,
                Info.Characteristics[(uint)KiirooGen1BluetoothInfo.Chrs.Tx],
            ...
            await Interface.WriteValue(ButtplugConsts.SystemMsgId,
                Info.Characteristics[(uint)KiirooGen1BluetoothInfo.Chrs.Cmd2],
            ...
            var res = await Interface.ReadValue(ButtplugConsts.SystemMsgId,
                Info.Characteristics[(int)KiirooGen1BluetoothInfo.Chrs.Cmd2]);
